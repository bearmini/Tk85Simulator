...
//***************************************************************************************************
/* TK85 キーボード クラス */
public class   TK85Keyboard extends Panel
  implements ParallelInputDevice, ParallelOutputDevice, MouseListener, ItemListener
  {
  // TK85 シミュレータ
...
/* Line 3  */   "RUN", "CONT", "ADDR SET", "READ DEC", "READ INC", "WR/ENT", "MODE", "REG",
/* Special */   "MON"
   };

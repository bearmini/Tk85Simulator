...
//***************************************************************************************************
/* SUI 命令 */
public class   InstructionSUI extends Instruction8085
  {
  public   InstructionSUI( CPU8085   cpu, byte   p1, String   p2, byte   p3 )
    {
    super( cpu, p1, p2, p3 );
    }
  ...
  public void   execute()
    ...
    cpu.updateFlags( CPU8085.FLAGUPDATE_ALL | CPU8085.FLAGUPDATE_SET_SUB );
    cpu.incPC( getSize() );
    }

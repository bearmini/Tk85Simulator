...
class Encoder8085 {
    ...
    // エンコードテーブル
    private Hashtable<String, Instruction8085> table = new Hashtable<String, Instruction8085>(
            256);
    ...
    public InstructionCode8085 encode(String opecode, String operand1,
        ...
        return new InstructionCode8085(inst.getSize(), inst.getOpecode(),
                inst.getB2(), inst.getB3());

...
public class TK85Simulator extends Thread {
    private SimulatorParent parent;

    private Frame frame;

    private TK85Keyboard keyboard;
    private TK85LED led;

    public CPU8085 cpu; // CPU
    public Mem8085 mem; // メモリ
    private Parallel8255 parallelio; // パラレルIC 8255
    private DMAController8085 dmac;
    ...
    private static final int CTRLW = 0xfb;

    // モニタプログラム ROM データ
    private static final short ROMDATA[] = {

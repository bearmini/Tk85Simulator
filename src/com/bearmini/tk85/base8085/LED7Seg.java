...
public class LED7Seg extends Canvas {
    ...
    // セグメント座標
    // a b c d e f g h
    private static final int x[] = { 8, 24, 24, 8, 5, 5, 8, 27 };
    private static final int y[] = { 5, 8, 25, 40, 25, 8, 22, 43 };
    private static final int w[] = { 16, 3, 3, 16, 3, 3, 16, 4 };
    private static final int h[] = { 3, 14, 15, 3, 15, 14, 3, 4 };
